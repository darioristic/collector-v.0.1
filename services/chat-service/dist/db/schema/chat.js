...
export const chatConversations = pgTable("chat_conversations", {
    ...
    chatConversationsUsersUnique: uniqueIndex("chat_conversations_users_unique").on(table.userId1, table.userId2, table.companyId),
    chatConversationsUser1Idx: index("chat_conversations_user1_idx").on(table.userId1),
    chatConversationsUser2Idx: index("chat_conversations_user2_idx").on(table.userId2),
    chatConversationsCompanyIdx: index("chat_conversations_company_idx").on(table.companyId),
}));
export const chatMessages = pgTable("chat_messages", {
    ...
    chatMessagesConversationIdx: index("chat_messages_conversation_idx").on(table.conversationId),
