import { listChannels, upsertDirectMessageChannel, } from "../lib/teamchat-repository.js";
import { authMiddleware } from "../lib/auth.js";
const channelsRoutes = async (fastify) => {
    ...
    fastify.get("/", async (request, reply) => {
        ...
        try {
            ...
            const channels = await listChannels(request.user.companyId, request.user.userId, cache);
    ...
    fastify.post("/", async (request, reply) => {
        ...
        try {
            const result = await upsertDirectMessageChannel(request.user.companyId, request.user.userId, body.targetUserId);
