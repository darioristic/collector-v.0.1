...
import { renderToStream, pdf, Document, Page, Text } from "@react-pdf/renderer";
import type { InvoicePDFProps } from "./types";
import type { TemplateProps, Template, LineItem as PkgLineItem } from "../../../../packages/templates/types.ts";
...
export async function renderMinimalToBuffer(message: string): Promise<Uint8Array> {
  const doc = (
    <Document>
