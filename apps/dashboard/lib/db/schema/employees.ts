...
export const employmentTypeEnum = pgEnum("employment_type", ["Full-time", "Contractor", "Intern"]);
...
export const employees = pgTable(
  "employees",
  {
    ...
    employmentType: employmentTypeEnum("employment_type").default("Full-time").notNull(),
  ...
  (table) => ({
    ...
    employmentTypeIdx: index("employees_employment_type_idx").on(table.employmentType),
