...
export function useProjectTimeline(projectId: string, options?: { enabled?: boolean }) {
...
export function useProjectBudget(projectId: string, options?: { enabled?: boolean }) {
  ...
  return useMutation({
    ...
    onError: (error) => {
      toast({
        ...
        description: error instanceof Error ? error.message : "Greška pri kreiranju projekta."
      });
    }
  });
}
...
export function useUpdateProject(projectId: string) {
  ...
  return useMutation({
    mutationFn: (input: ProjectUpdatePayload) => updateProject(projectId, input),
    onSuccess: async () => {
      await Promise.all([
    ...
    onError: (error) => {
      toast({
        ...
        description: error instanceof Error ? error.message : "Greška pri ažuriranju projekta."
      });
    }
  });
}

export function useDeleteProject(projectId: string, options?: { onDeleted?: () => void }) {
  const queryClient = useQueryClient();
  const { toast } = useToast();
  ...
  return useMutation({
    ...
    onError: (error) => {
      toast({
        ...
        description: error instanceof Error ? error.message : "Greška pri brisanju projekta."
      });
    }
  });
}
...
export function useCreateProjectTask(projectId: string) {
  ...
  return useMutation({
    mutationFn: (input: CreateTaskPayload) => createProjectTask(projectId, input),
    onSuccess: async () => {
      await Promise.all([
        queryClient.invalidateQueries({ queryKey: projectKeys.detail(projectId) }),
    ...
    onError: (error) => {
      toast({
        ...
        description: error instanceof Error ? error.message : "Greška pri dodavanju zadatka."
      });
    }
  });
}
...
export function useUpdateProjectTask(projectId: string) {
  ...
  return useMutation({
    mutationFn: ({ taskId, input }: { taskId: string; input: UpdateTaskPayload }) =>
    ...
    onError: (error) => {
      toast({
        variant: "destructive",
        title: "Ažuriranje neuspešno",
        description: error instanceof Error ? error.message : "Greška pri ažuriranju zadatka."
      });
    }
  });
}
  ...
  return useMutation({
    ...
    onError: (error) => {
      toast({
        variant: "destructive",
        title: "Brisanje neuspešno",
        description: error instanceof Error ? error.message : "Greška pri brisanju zadatka."
      });
    }
  });
}
...
export function useCreateTimelineEvent(projectId: string) {
  ...
  return useMutation({
    mutationFn: (input: CreateTimelinePayload) => createTimelineEvent(projectId, input),
    onSuccess: async () => {
      await Promise.all([
        queryClient.invalidateQueries({ queryKey: projectKeys.detail(projectId) }),
    ...
    onError: (error) => {
      toast({
        ...
        title: "Dodavanje neuspešno",
        description:
          error instanceof Error ? error.message : "Greška pri dodavanju stavke na vremensku liniju."
      });
    }
  });
}
...
export function useUpdateTimelineEvent(projectId: string) {
  ...
  return useMutation({
    mutationFn: ({ eventId, input }: { eventId: string; input: UpdateTimelinePayload }) =>
    ...
    onError: (error) => {
      toast({
        variant: "destructive",
        title: "Ažuriranje neuspešno",
        description: error instanceof Error ? error.message : "Greška pri ažuriranju vremenske linije."
      });
    }
  });
}
  ...
  return useMutation({
    ...
    onError: (error) => {
      toast({
        variant: "destructive",
        title: "Brisanje neuspešno",
        description: error instanceof Error ? error.message : "Greška pri brisanju stavke."
      });
    }
  });
}
...
export function useAddTeamMember(projectId: string) {
  ...
  return useMutation({
    mutationFn: (input: AddTeamMemberPayload) => addTeamMember(projectId, input),
    onSuccess: async () => {
      await Promise.all([
        queryClient.invalidateQueries({ queryKey: projectKeys.detail(projectId) }),
    ...
    onError: (error) => {
      toast({
        variant: "destructive",
        title: "Dodavanje neuspešno",
        description: error instanceof Error ? error.message : "Greška pri dodavanju člana tima."
      });
    }
  });
}
  ...
  return useMutation({
    ...
    onError: (error) => {
      toast({
        ...
        description: error instanceof Error ? error.message : "Greška pri uklanjanju člana tima."
      });
    }
  });
}
...
export function useUpdateProjectBudget(projectId: string) {
  ...
  return useMutation({
    mutationFn: (input: UpdateBudgetPayload) => updateProjectBudget(projectId, input),
    onSuccess: async () => {
      await Promise.all([
        queryClient.invalidateQueries({ queryKey: projectKeys.detail(projectId) }),
    ...
    onError: (error) => {
      toast({
        variant: "destructive",
        title: "Ažuriranje neuspešno",
        description: error instanceof Error ? error.message : "Greška pri ažuriranju budžeta."
      });
    }
  });
}
...
export function useCreateBudgetCategory(projectId: string) {
  ...
  return useMutation({
    mutationFn: (input: CreateBudgetCategoryPayload) => createBudgetCategory(projectId, input),
    onSuccess: async () => {
      await Promise.all([
        queryClient.invalidateQueries({ queryKey: projectKeys.detail(projectId) }),
        queryClient.invalidateQueries({ queryKey: projectKeys.budget(projectId) })
    ...
    onError: (error) => {
      toast({
        variant: "destructive",
        title: "Dodavanje neuspešno",
        description: error instanceof Error ? error.message : "Greška pri dodavanju kategorije."
      });
    }
  });
}
...
export function useUpdateBudgetCategory(projectId: string) {
  ...
  return useMutation({
    mutationFn: ({ categoryId, input }: { categoryId: string; input: UpdateBudgetCategoryPayload }) =>
    ...
    onError: (error) => {
      toast({
        variant: "destructive",
        title: "Ažuriranje neuspešno",
        description: error instanceof Error ? error.message : "Greška pri ažuriranju kategorije."
      });
    }
  });
}
  ...
  return useMutation({
    ...
    onError: (error) => {
      toast({
        variant: "destructive",
        title: "Brisanje neuspešno",
        description: error instanceof Error ? error.message : "Greška pri brisanju kategorije."
      });
    }
  });
}
