  ...
  return useMutation({
    ...
    onError: (error) => {
      toast({
        ...
        description: error instanceof Error ? error.message : "Unable to create the order."
      });
    }
  });
}
...
export function useUpdateOrder() {
  ...
  return useMutation({
    mutationFn: async ({ id, input }: { id: number; input: OrderUpdateInput }) =>
    ...
    onError: (error) => {
      toast({
        variant: "destructive",
        title: "Update failed",
        description: error instanceof Error ? error.message : "Unable to update the order."
      });
    }
  });
}
  ...
  return useMutation({
    ...
    onError: (error) => {
      toast({
        variant: "destructive",
        title: "Delete failed",
        description: error instanceof Error ? error.message : "Unable to delete the order."
      });
    }
  });
}