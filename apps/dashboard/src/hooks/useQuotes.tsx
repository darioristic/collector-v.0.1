  ...
  return useMutation({
    ...
    onError: (error) => {
      toast({
        ...
        description: error instanceof Error ? error.message : "Unable to create the quote."
      });
    }
  });
}
...
export function useUpdateQuote() {
  ...
  return useMutation({
    mutationFn: async ({ id, input }: { id: number; input: QuoteUpdateInput }) =>
    ...
    onError: (error) => {
      toast({
        variant: "destructive",
        title: "Update failed",
        description: error instanceof Error ? error.message : "Unable to update the quote."
      });
    }
  });
}
  ...
  return useMutation({
    ...
    onError: (error) => {
      toast({
        variant: "destructive",
        title: "Delete failed",
        description: error instanceof Error ? error.message : "Unable to delete the quote."
      });
    }
  });
}