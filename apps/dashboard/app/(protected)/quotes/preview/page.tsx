					...
					<div className="text-sm space-y-1">
						...
						<div className="flex gap-6">
							...
							<span className="font-medium">
								{draft?.issueDate
									? format(new Date(draft.issueDate), "dd/MM/yyyy")
									: "—"}
							</span>
						</div>
						<div className="flex gap-6">
							...
							<span className="font-medium">
								{draft?.expiryDate
									? format(new Date(draft.expiryDate), "dd/MM/yyyy")
									: "—"}
							</span>
						</div>
					</div>
					...
					<Table>
						<TableHeader>
							<TableRow className="bg-muted/30">
								<TableHead className="w-[50px] text-[12px] font-semibold tracking-wide text-muted-foreground">
									#
								</TableHead>
								<TableHead className="text-[12px] font-semibold tracking-wide text-muted-foreground">
									Description
								</TableHead>
								<TableHead className="w-[100px] text-right text-[12px] font-semibold tracking-wide text-muted-foreground">
									Qty
								</TableHead>
								<TableHead className="w-[120px] text-right text-[12px] font-semibold tracking-wide text-muted-foreground">
									Unit Price
								</TableHead>
								<TableHead className="w-[120px] text-right text-[12px] font-semibold tracking-wide text-muted-foreground">
									Total
