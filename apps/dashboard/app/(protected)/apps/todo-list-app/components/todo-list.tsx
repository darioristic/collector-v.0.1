...
import { FilterTab, Todo, TodoStatus } from "@/app/(protected)/apps/todo-list-app/types";
...
import TodoItem from "@/app/(protected)/apps/todo-list-app/components/todo-item";
import { useTodoStore } from "@/app/(protected)/apps/todo-list-app/store";
import StatusTabs from "@/app/(protected)/apps/todo-list-app/components/status-tabs";
