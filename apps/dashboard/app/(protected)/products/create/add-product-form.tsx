...
import { z } from "zod";
import AddNewCategory from "@/app/(protected)/products/create/add-category";
import { AddMediaFromUrl } from "@/app/(protected)/products/create/add-media-from-url";
									...
									render={({ field: _field }) => (
										<div className="flex flex-col gap-2">
											<div
												...
												className="border-input data-[dragging=true]:bg-accent/50 has-[input:focus]:border-ring has-[input:focus]:ring-ring/50 relative flex min-h-52 flex-col items-center overflow-hidden rounded-xl border border-dashed p-4 transition-colors data-[files]:justify-start has-[input:focus]:ring-[3px]"
											>
												<input
													{...getInputProps()}
													className="sr-only"
