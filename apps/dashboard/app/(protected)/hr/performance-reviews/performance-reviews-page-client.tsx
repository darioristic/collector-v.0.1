...
const mapFormValuesToApiPayload = (
	...
	periodStart: values.periodStart
		? values.periodStart.toISOString()
		: undefined,
...
export default function PerformanceReviewsPageClient({
	...
	const [queryState, setQueryState] =
		React.useState<PerformanceReviewsQueryState>({
			...initialQuery,
	...
	const [formInitialValues, setFormInitialValues] = React.useState<
		PerformanceReviewFormValues | undefined
	>(undefined);
	...
	return (
		<div className="space-y-8">
			...
			<DeletePerformanceReviewDialog
				...
				reviewDate={
					reviewToDelete
						? new Date(reviewToDelete.reviewDate).toLocaleDateString()
						: null
				}
