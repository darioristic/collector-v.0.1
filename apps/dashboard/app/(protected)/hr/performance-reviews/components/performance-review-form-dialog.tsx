...
import { performanceReviewFormSchema, type PerformanceReviewFormValues } from "../schemas";
  ...
  return (
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="max-w-2xl">
        <DialogHeader>
          <DialogTitle>
            {mode === "create" ? "Add Performance Review" : "Edit Performance Review"}
          </DialogTitle>
          <DialogDescription>
            {mode === "create"
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input {...field} value={field.value ?? ""} placeholder="Enter reviewer UUID" />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
