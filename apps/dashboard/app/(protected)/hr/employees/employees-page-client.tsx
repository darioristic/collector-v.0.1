...
const isEmploymentType = (value: string | undefined): value is EmploymentType =>
	typeof value === "string" &&
	(employmentTypeValues as readonly string[]).includes(value);

const isEmploymentStatus = (
	value: string | undefined,
): value is EmploymentStatus =>
	typeof value === "string" &&
	(employmentStatusValues as readonly string[]).includes(value);
	...
	const handleFiltersChange = React.useCallback(
		(nextFilters: {
			...
			setQueryState((prev) => ({
				...
				status: isEmploymentStatus(nextFilters.status)
					? nextFilters.status
					: undefined,
	...
	return (
		<div className="space-y-8">
				...
				<div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
					<div>
						...
						<p className="text-muted-foreground mt-1 text-sm">
							Stay on top of your workforce, manage status changes, and keep
			...
			<AddEmployeeDialog>
				<Button
					type="button"
					className="fixed right-6 bottom-6 z-50 shadow-lg sm:hidden"
				>
