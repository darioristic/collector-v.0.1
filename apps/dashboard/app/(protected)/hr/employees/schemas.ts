...
export const toEmployeeFormInput = (values?: EmployeeFormValues | null): EmployeeFormInput => ({
  ...
  salary:
    values?.salary !== undefined && values?.salary !== null && !Number.isNaN(values.salary)
...
export const parseEmployeesQueryState = (params: Record<string, string | string[] | undefined>): EmployeesQueryState => {
