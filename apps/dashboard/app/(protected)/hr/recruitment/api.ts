...
export async function createCandidate(values: Partial<Candidate>): Promise<Candidate> {
...
export async function createInterview(values: Partial<Interview>): Promise<Interview> {
