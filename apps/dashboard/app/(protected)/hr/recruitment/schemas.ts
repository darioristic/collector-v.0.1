...
export function parseCandidatesQueryState(
  ...
  return {
    status: typeof searchParams.status === "string" ? searchParams.status as CandidatesQueryState["status"] : undefined,
    position: typeof searchParams.position === "string" ? searchParams.position : undefined,
...
export function parseInterviewsQueryState(
  ...
  return {
    candidateId: typeof searchParams.candidateId === "string" ? searchParams.candidateId : undefined,
    interviewerId: typeof searchParams.interviewerId === "string" ? searchParams.interviewerId : undefined,
    status: typeof searchParams.status === "string" ? searchParams.status as InterviewsQueryState["status"] : undefined,
    limit: typeof searchParams.limit === "string" ? parseInt(searchParams.limit, 10) : undefined,
    offset: typeof searchParams.offset === "string" ? parseInt(searchParams.offset, 10) : undefined,
  };
}
