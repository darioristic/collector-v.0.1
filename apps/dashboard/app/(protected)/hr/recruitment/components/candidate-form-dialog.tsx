...
import { candidateFormSchema, type CandidateFormValues } from "../schemas";
  ...
  return (
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="max-w-2xl">
        <DialogHeader>
          <DialogTitle>{mode === "create" ? "Add Candidate" : "Edit Candidate"}</DialogTitle>
          <DialogDescription>
            {mode === "create"
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <DialogFooter>
              ...
              <Button type="submit" disabled={isSubmitting}>
                {isSubmitting ? "Saving..." : mode === "create" ? "Add Candidate" : "Save Changes"}
              </Button>
            </DialogFooter>
          </form>
        </Form>
