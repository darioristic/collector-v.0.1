...
import type { Activity, ActivityCreateInput, ActivityPriority, ActivityStatus, ActivityType } from "@crm/types";
...
const activityPriorityEnum = z.enum([...ACTIVITY_PRIORITY_OPTIONS.map((option) => option.value)] as [
  ActivityPriority,
  ...ActivityPriority[]
]);
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <Select onValueChange={field.onChange} value={field.value} disabled={assignees.length === 0}>
                  <FormControl>
                    <SelectTrigger>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="md:col-span-2">
                ...
                <FormControl>
                  <Textarea rows={4} placeholder="Key talking points, context, or follow-up steps" {...field} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
