...
export function ListView({
  ...
  const isAllPageSelected =
    paginatedActivities.length > 0 && paginatedActivities.every((activity) => selectedIds.has(activity.id));
    ...
    <div className="space-y-4">
      <div className="bg-background overflow-hidden rounded-xl border shadow-sm">
        <div className="flex items-center justify-between border-b px-4 py-3">
          <h3 className="text-base font-semibold tracking-tight">Activities List</h3>
                    ...
                    <TableRow key={activity.id} className="group">
                      <TableCell className="align-top">
                        <Checkbox
                          ...
                          onCheckedChange={(checked) => handleToggleOne(activity.id, Boolean(checked))}
                        />
                      </TableCell>
                      <TableCell className="align-top">
