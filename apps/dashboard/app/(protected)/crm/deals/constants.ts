...
export const DEAL_STAGE_BADGE_CLASSNAME: Record<DealStage, string> = {
  ...
  Qualified: "bg-indigo-100 text-indigo-800 dark:bg-indigo-500/15 dark:text-indigo-300",
  Proposal: "bg-amber-100 text-amber-900 dark:bg-amber-500/15 dark:text-amber-300",
  Negotiation: "bg-purple-100 text-purple-800 dark:bg-purple-500/15 dark:text-purple-300",
  "Closed Won": "bg-emerald-100 text-emerald-800 dark:bg-emerald-500/15 dark:text-emerald-300",
  "Closed Lost": "bg-rose-100 text-rose-800 dark:bg-rose-500/15 dark:text-rose-300",
};
