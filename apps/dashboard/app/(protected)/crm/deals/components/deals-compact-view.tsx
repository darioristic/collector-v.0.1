    ...
    <div className="space-y-4">
      <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4">
        {paginatedDeals.map((deal) => {
          ...
          return (
            <Card key={deal.id} className="flex h-full flex-col gap-4 overflow-hidden border border-border/70 bg-card/95 shadow-sm">
              ...
              <div className="flex flex-wrap items-center gap-2 border-y border-border/60 px-4 py-3">
                <Badge className={cn("rounded-full px-3 py-1 text-xs font-semibold uppercase", DEAL_STAGE_BADGE_CLASSNAME[stage])}> 
                  {stage}
                </Badge>
              ...
              <div className="px-4 text-sm text-muted-foreground">
                <p className="line-clamp-3 leading-relaxed">
                  {deal.notes ?? "Keep stakeholders aligned and monitor key milestones to move this deal forward."}
                </p>
              </div>

              <div className="grid grid-cols-2 gap-4 px-4 text-sm">
                <div className="space-y-1">
                  <span className="text-muted-foreground text-xs uppercase tracking-wide">Owner</span>
                ...
                <div className="space-y-1">
                  <span className="text-muted-foreground text-xs uppercase tracking-wide">Close Date</span>
                ...
                <div className="space-y-1">
                  <span className="block text-muted-foreground text-xs uppercase tracking-wide">Stage Accent</span>
                  <span className={cn("inline-flex rounded-full px-2.5 py-1 text-xs font-medium", stageAccent[stage])}>{stage}</span>
                </div>
              </div>
            </Card>
          );
