...
export default async function InvoiceHtmlPreviewPage({
	...
	const customerDetails = {
		...
		content: [
			{
				type: "paragraph",
				content: [{ type: "text", text: invoice.customerName || "" }],
			},
			{
				type: "paragraph",
				content: [{ type: "text", text: invoice.customerEmail || "" }],
			},
			{
				type: "paragraph",
				content: [{ type: "text", text: invoice.billingAddress || "" }],
			},
		...
		content: [
			{
				type: "paragraph",
				content: [
					{ type: "text", text: "Bank: — | Account number: — | IBAN: —" },
				],
			},
		],
	};
	...
	return (
      ...
      `,
			...
			<HtmlTemplate
				...
				note_details={
					noteDetails as
						| import("@/components/invoices/templates/types").EditorDoc
						| undefined
				}
