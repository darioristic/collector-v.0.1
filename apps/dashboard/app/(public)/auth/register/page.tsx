...
const registerSchema = z
	.object({
		companyName: z
			.string()
			.min(2, "Naziv kompanije mora imati bar 2 karaktera."),
		companyDomain: z
			.string()
			.trim()
			.optional()
		...
		<div className="flex items-center justify-center py-4 lg:h-screen">
			<Card className="mx-auto w-full max-w-2xl">
				<CardHeader>
					...
					<CardDescription>
						Otvori nalog za svoju kompaniju i pozovi tim kada završiš inicijalno
						podešavanje.
					</CardDescription>
				</CardHeader>
				<CardContent>
