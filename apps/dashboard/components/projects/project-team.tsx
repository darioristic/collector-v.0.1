...
import type { AddTeamMemberPayload, ProjectTeamMember } from "@/src/types/projects";
...
export function ProjectTeam({ team, onAddMember, onRemoveMember, isMutating }: ProjectTeamProps) {
      ...
      <CardContent>
        {team.length === 0 ? (
          <div className="rounded-lg border border-dashed p-8 text-center text-sm text-muted-foreground">
            Još uvek nema dodeljenih članova. Dodajte kolege kako biste podelili odgovornosti.
          </div>
        ) : (
              ...
              <div
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex flex-1 flex-col gap-1">
                    ...
                    <Badge variant="outline" className="mt-2 w-max rounded-full px-3 py-1 text-xs">
                      {member.role}
                    </Badge>
