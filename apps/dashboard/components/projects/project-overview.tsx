...
const statusVariants: Record<string, string> = {
  ...
  completed: "bg-purple-100 text-purple-700 dark:bg-purple-500/10 dark:text-purple-200"
};
      ...
      <CardContent className="space-y-6 py-6">
        <div>
          <div className="flex items-center justify-between text-sm font-medium">
            <span>Napravljeno {project.completedTasks} od {project.totalTasks} zadataka</span>
            <span>{project.progress}%</span>
          </div>
          <Progress value={project.progress} className="mt-3 h-3 rounded-full bg-muted" />
        </div>
