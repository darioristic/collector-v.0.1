    ...
    <Card>
      ...
      <CardContent className="space-y-6">
              ...
              <Table>
                ...
                <TableBody>
                  {invoice.items.map((item) => (
                    <TableRow key={item.id}>
                      ...
                      <TableCell className="text-right">{item.discountRate}%</TableCell>
                ...
                <TableFooter>
                  <TableRow>
                    ...
                    <TableCell className="text-right font-medium">
                      {formatCurrency(invoice.amountBeforeDiscount, invoice.currency)}
                    </TableCell>
                  </TableRow>
                  <TableRow>
                    <TableCell colSpan={5} className="text-right font-medium">
        ...
        <div className="grid grid-cols-2 gap-4 text-sm text-muted-foreground">
          <div>
            <span className="font-medium">Created:</span> {new Date(invoice.createdAt).toLocaleString()}
          </div>
          <div>
            <span className="font-medium">Updated:</span> {new Date(invoice.updatedAt).toLocaleString()}
          </div>
        </div>
      </CardContent>
    </Card>
