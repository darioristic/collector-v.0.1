          ...
          <div className="grid gap-4 py-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="grid gap-2">
                ...
                <Input
                  ...
                  {...register("quoteNumber", { required: "Quote number is required" })}
                />
                {errors.quoteNumber && (
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="grid gap-2">
                ...
                <Input id="companyId" placeholder="Optional" {...register("companyId")} />
              </div>

              <div className="grid gap-2">
                <Label htmlFor="contactId">Contact ID</Label>
                <Input id="contactId" placeholder="Optional" {...register("contactId")} />
              </div>
            </div>
                    ...
                    {fields.map((field, index) => (
                      <TableRow key={field.id}>
                        ...
                        <TableCell className="font-medium">
                          {((items[index]?.quantity || 0) * (items[index]?.unitPrice || 0)).toFixed(
                            2
                          )}
                        </TableCell>
                        <TableCell>
